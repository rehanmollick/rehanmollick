...
| | |
|---|---|
| 🌊 **[Freshet](https://github.com/rehanmollick/freshet)** <br/><sub>`Python` `FastAPI` `Celery` `Next.js`</sub> | Type any U.S. address → an engineering-grade flood-risk score from **6 live federal data sources** and real civil-engineering math. The missing product between a free FEMA map and a $30K engineering study. **Live at [freshet.ai](https://freshet.ai)**. |
